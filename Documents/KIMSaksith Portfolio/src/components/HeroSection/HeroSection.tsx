...
import { ArrowRight, Download, Linkedin, Mail, Send } from "lucide-react";
    ...
    <section id="hero" className="relative min-h-[100vh] flex flex-col pt-12 md:pt-16 overflow-hidden bg-background">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full flex-1 flex flex-col md:flex-row items-center justify-center gap-12 md:gap-20 pb-12">
        ...
        >
          ...
          >
            I help self-service banking
run smarter and move
faster
Self-Service Banking Integration · Workflow Design · UAT Testing · Operations & Support
          </motion.p>
          ...
          >
            ...
            <a href="https://drive.google.com/file/d/1auTmGm1AyPpaGMjZ94bwjHwuvI1qmb9W/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
          ...
          >
            {[
              { icon: Linkedin, href: "https://www.linkedin.com/in/kim-saksith-a61243240/", label: "LinkedIn" },
              { icon: Send, href: "https://t.me/SithAlgo", label: "Telegram" },
              { icon: Mail, href: "https://mail.google.com/mail/?view=cm&fs=1&to=saksithlove@gmail.com", label: "Email" },
  ...
  <div className="absolute bottom-1 right-2 w-4 h-4 rounded-full bg-emerald-500 border-2 border-white shadow-md" />
              ...
              <div className="p-5 flex flex-col items-center text-center bg-card text-card-foreground flex-1 gap-3">
                <div>
                  <h3 className="text-xl font-extrabold tracking-tight text-foreground">KIM Saksith</h3>
                  <div className="inline-flex items-center gap-1.5 mt-1 px-3 py-0.5 rounded-full bg-primary/10 border border-primary/30 text-primary text-xs font-semibold">
                    <span>Senior Terminal Product Development</span>
                  </div>
                </div>
