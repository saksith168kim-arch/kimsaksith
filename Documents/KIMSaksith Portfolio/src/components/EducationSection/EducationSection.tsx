 ...
 const education = [
    {
      ...
      year: "2017 – 2023",
      badge: "Capstone Projects",
      badgeIcon: Award,
      badgeColor: "text-emerald-400 bg-emerald-500/10 border-emerald-500/30",
      icon: GraduationCap,
      details: [
        "Focused on software engineering, database systems, and application development",
        "Built a Bus Management System and a Student Management System as capstone projects",
        "Developed strong foundations in C#, C++, and web technologies (HTML, CSS, JavaScript)",
        "Applied coursework directly to real-world ATM/CRM terminal systems at ABA Bank"
      ]
    },
    {
      ...
      icon: BookOpen,
      details: [
        "Completed a second bachelor's degree in English alongside Computer Science studies",
        "Strengthened technical writing, documentation, and communication skills",
        "Supported effective collaboration with vendors and cross-functional teams",
        "Balanced two concurrent degree programs over the same period"
      ]
    }
  ];
