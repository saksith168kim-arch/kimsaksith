...
export default function ProfessionalProfile() {
  const technicalSkills = [
    { name: "ATM/CRM Systems & NDC/TranzWare", level: 95, icon: Terminal, color: "text-cyan-400" },
    { name: "Terminal Development & UAT Testing", level: 92, icon: CreditCard, color: "text-emerald-400" },
    { name: "C# / C++ & Web (HTML/CSS/JS)", level: 88, icon: Code2, color: "text-blue-400" },
    { name: "Databases & System Configurations", level: 85, icon: Database, color: "text-amber-400" },
    { name: "Tools (Jira, Confluence, Zabbix)", level: 90, icon: Layers, color: "text-purple-400" },
  ];

  const softSkills = [
    { name: "Project Coordination", icon: Workflow, color: "text-amber-400 border-amber-500/30 bg-amber-500/10" },
    { name: "Problem Solving & Troubleshooting", icon: Brain, color: "text-purple-400 border-purple-500/30 bg-purple-500/10" },
    { name: "Cross-Functional Collaboration", icon: Users, color: "text-sky-400 border-sky-500/30 bg-sky-500/10" },
    { name: "Team Management", icon: ShieldCheck, color: "text-rose-400 border-rose-500/30 bg-rose-500/10" },
    { name: "Strategic Thinking", icon: Lightbulb, color: "text-yellow-400 border-yellow-500/30 bg-yellow-500/10" },
    { name: "Mentoring Junior Members", icon: Users, color: "text-emerald-400 border-emerald-500/30 bg-emerald-500/10" },
  ];
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-r from-primary/10 via-purple-500/5 to-transparent border border-primary/20 flex items-start gap-3.5 shadow-sm">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Continuously evolving with cutting-edge banking technologies, automated UAT flows, and robust system configurations.
                </p>
              </div>
            </div>
          </div>
